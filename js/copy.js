...
function initClickableContactIcons(){
  ...
  items.forEach(item=>{
    ...
    else if (has('.fa-phone')) { activate(iconBox, ()=>{ showCopyNotification(t('popup.phone')); }, 'Informação telefónica sob pedido'); }
...
function initCopyElements(){
  ...
  copyElements.forEach(el=>{
    const activate = (ev)=>{
      ...
      if (textToCopy === 'phone-info') { showCopyNotification(t('popup.phone')); return; }
